...
If you're interested in volunteering, or have a question or comment join us on chat using Element (Riot) - room #iSTPWG:matrix.org ([download the Element client]https://element.io/get-started)), or you can DM Simon Worthington on Twitter [@mrchristian99](https://twitter.com/mrchristian99) or email publications@independentsage.org.
